...
MR_decl_label3(alib__rlines_4_0, 2,5,4)
...
MR_def_extern_entry(fn__alib__l_1_0)
...
MR_BEGIN_MODULE(alib_module2)
	...
	MR_init_label3(alib__rlines_4_0,2,5,4)
MR_BEGIN_CODE
...
MR_def_label(alib__rlines_4_0, 2)
	...
	MR_np_call_localret_ent(io__print_3_0,
		alib__rlines_4_0_i5);
MR_def_label(alib__rlines_4_0, 5)
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
	MR_r1 = (MR_Unsigned) 0U;
...
MR_BEGIN_MODULE(alib_module3)
	MR_init_entry1(fn__alib__l_1_0);
	MR_INIT_PROC_LAYOUT_ADDR(mercury__fn__alib__l_1_0);
MR_BEGIN_CODE
...
/* code for 'l'/2 mode 0 */
	...
	#define MR_maybe_local_thread_engine_base MR_local_thread_engine_base
#endif
MR_define_entry(mercury__fn__alib__l_1_0);
	MR_MAYBE_INIT_LOCAL_THREAD_ENGINE_BASE
